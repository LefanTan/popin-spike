...
export async function checkLocationPermissionAsync(successCallback: () => void = () => null, failureCallback: () => void = () => null) {
...
export async function requestLocationPermissionAsync(onSuccess: () => void = () => null, onFailure: () => void = () => null) {
